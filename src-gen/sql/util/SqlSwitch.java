...
public class SqlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SqlPackage.BANCO: {
			Banco banco = (Banco) theEObject;
			T result = caseBanco(banco);
			if (result == null)
		...
		case SqlPackage.COLUNA: {
			Coluna coluna = (Coluna) theEObject;
			T result = caseColuna(coluna);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case SqlPackage.CHAVE_ESTRANGEIRA: {
			ChaveEstrangeira chaveEstrangeira = (ChaveEstrangeira) theEObject;
			T result = caseChaveEstrangeira(chaveEstrangeira);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Banco</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Banco</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBanco(Banco object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Coluna</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Coluna</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseColuna(Coluna object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Chave Estrangeira</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Chave Estrangeira</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseChaveEstrangeira(ChaveEstrangeira object) {
		return null;
	}
