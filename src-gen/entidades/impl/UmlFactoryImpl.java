...
public class UmlFactoryImpl extends EFactoryImpl implements UmlFactory {
	...
	public Relacionamento createRelacionamento() {
		RelacionamentoImpl relacionamento = new RelacionamentoImpl();
	 ...
	 */
	@Override
	public ModeloEntidade createModeloEntidade() {
		ModeloEntidadeImpl modeloEntidade = new ModeloEntidadeImpl();
